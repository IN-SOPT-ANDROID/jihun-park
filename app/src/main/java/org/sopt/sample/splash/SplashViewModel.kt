...
class SplashViewModel : ViewModel() {
    ...
    private var _isSignedUser = MutableStateFlow<Event<Boolean>>(Event(false))
    val isSignedUser: StateFlow<Event<Boolean>> get() = _isSignedUser
    ...
    private suspend fun checkSignedUser() {
        _isSignedUser.value = Event(ApplicationClass.getInstance().getUserManager().getUserInfo() != null)
    }
}